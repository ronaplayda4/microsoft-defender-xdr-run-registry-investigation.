...
What process modified the Windows Run registry key?
What executable was referenced by the registry value?
Was the process chain expected or suspicious?
Was the file trusted and known to security vendors?
Was this a one-time event or part of an established baseline?
1. Incident Triage
